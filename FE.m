%% 1D Galerkin with forward Euler time derivative discretization
...
%% 1D Finite Element Heat Equation Addition with forward Euler
% Time step
dt = 1/551;
T0 = 0;
Tf = 1;
...
for n = 1:nt
    ...
    u = u - dt*pinv(M)*K*u+dt*pinv(M)*Fn;
end
